...
class Simulation:
    def __init__(self, sun_radius=sun_radius, M_sun=M_sun, earth_radius=earth_radius, M_earth=M_earth,
        ...
        self._planets.append(Planete("Mars", mars_radius, M_mars, x_mars, y_mars, z_mars, vx_mars, vy_mars, vz_mars))
    ...
    def _plot(self):
        ...
        animated_mars, = ax.plot([self._planets[1]._pos_x[0]], [self._planets[1]._pos_y[0]], [self._planets[1]._pos_z[0]+0.05], 'o', color='red')
        ...
        def _update(i):
            ...
            animated_mars.set_data([self._planets[1]._pos_x[i]], [self._planets[1]._pos_y[i]])
            animated_mars.set_3d_properties([self._planets[1]._pos_z[i] + 0.05])
            return animated_earth, animated_mars
